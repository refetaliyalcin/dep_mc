...
#Add macros
SET_COMPILE_FLAG(CMAKE_Fortran_FLAGS "${CMAKE_Fortran_FLAGS}"
                 Fortran "-fpp -no-wrap-margin"        # Intel
                         "/fpp /no-wrap-maring"       # Intel Windows
                         "-cpp"   # GNU
                )
...
SET_COMPILE_FLAG(CMAKE_Fortran_FLAGS "${CMAKE_Fortran_FLAGS}"
                 Fortran "-DMLFMM" # All compilers not on Windows
                )
...
SET_COMPILE_FLAG(CMAKE_Fortran_FLAGS_DEBUG "${CMAKE_Fortran_FLAGS_DEBUG}"
                 Fortran "-check bounds"  # Intel
                         "/check:bounds"  # Intel Windows
                         "-ffpe-trap=invalid,underflow,overflow,zero,denormal" # GNU (New style)
                         "-ffpe-trap=invalid,underflow,overflow,zero,denormal" # GNU (New style)
                         "-Mbounds"       # Portland Group
                )
...
#TV: BUG: flto crashes the code with gcc 5.4
#
