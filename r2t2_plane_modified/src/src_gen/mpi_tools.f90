...
#define SIZEOFDATABLOCK 34
#define NUMOFARRAYSINDB 16
...
!#MPITOOLS_SCRIPT001
        ...
        MPIUNPACKREAL(dB%ell)
        MPIUNPACKREAL(dB%Fstop)
        MPIUNPACKREAL(dB%the0)
        MPIUNPACKREAL(dB%phi0)
        MPIUNPACKREAL(dB%phiout)
        MPIUNPACKREAL(dB%tau_c)
        MPIUNPACKREAL(dB%hr)
        MPIUNPACKREAL(dB%volrad)
        MPIUNPACKREAL(dB%runtime)
        MPIUNPACKINTEGER(dB%seed)
        MPIUNPACKINTEGER(dB%ntot)
        MPIUNPACKINTEGER(dB%nsca)
        MPIUNPACKINTEGER(dB%nrot)
        MPIUNPACKLOGICAL(dB%addInfo)
        MPIUNPACKLOGICAL(dB%estimateTime)
        MPIUNPACKLOGICAL(dB%forced_vm)
        MPIUNPACKLOGICAL(dB%surface_att)
        MPIUNPACKLOGICAL(dB%overlap_prob)
        MPIUNPACKLOGICAL(dB%albedo_override)
        MPIUNPACKINTEGER(dB%ntheb)
        MPIUNPACKINTEGER(dB%nphib)
        MPIUNPACKINTEGER(dB%nthe)
        MPIUNPACKINTEGER(dB%nphi)
        MPIUNPACKREAL(dB%ffboundary)
        MPIUNPACKLOGICAL(dB%polQp)
        MPIUNPACKLOGICAL(dB%polQm)
        MPIUNPACKLOGICAL(dB%polUp)
        MPIUNPACKLOGICAL(dB%polUm)
        MPIUNPACKLOGICAL(dB%polVp)
        MPIUNPACKLOGICAL(dB%polVm)
        MPIUNPACKLOGICAL(dB%cb_on)
!#MPITOOLS_SCRIPT002
...
!#MPITOOLS_SCRIPT301
        ...
        MPIADDRESS(dB%tau_c)
        MPIADDRESS(dB%hr)
        MPIADDRESS(dB%volrad)
        MPIADDRESS(dB%runtime)
        MPIADDRESS(dB%seed)
        MPIADDRESS(dB%ntot)
        MPIADDRESS(dB%nsca)
        MPIADDRESS(dB%nrot)
        MPIADDRESS(dB%addInfo)
        MPIADDRESS(dB%estimateTime)
        MPIADDRESS(dB%forced_vm)
        MPIADDRESS(dB%surface_att)
        MPIADDRESS(dB%overlap_prob)
        MPIADDRESS(dB%albedo_override)
        MPIADDRESS(dB%ntheb)
        MPIADDRESS(dB%nphib)
        MPIADDRESS(dB%nthe)
        MPIADDRESS(dB%nphi)
        MPIADDRESS(dB%ffboundary)
        MPIADDRESS(dB%polQp)
        MPIADDRESS(dB%polQm)
        MPIADDRESS(dB%polUp)
        MPIADDRESS(dB%polUm)
...
!#MPITOOLS_SCRIPT302
    ...
    !!Read arrays from the buffer
        ...
        indPos=0
!#MPITOOLS_SCRIPT401
        SUBREADBUFFER(dB%CTHEIF)
        SUBREADBUFFER(dB%STHEIF)
        SUBREADBUFFER(dB%INORM)
        SUBREADBUFFER(dB%STHEI)
        SUBREADBUFFER(dB%CTHEI)
        SUBREADBUFFER(dB%CPHII)
        SUBREADBUFFER(dB%SPHII)
        SUBREADBUFFER(dB%THEBF)
        SUBREADBUFFER(dB%CTHEBF)
        SUBREADBUFFER(dB%STHEBF)
        SUBREADBUFFER(dB%STHEB)
        SUBREADBUFFER(dB%CTHEB)
        SUBREADBUFFER(dB%CPHIB)
        SUBREADBUFFER(dB%SPHIB)
        SUBREADBUFFER(dB%PHIB)
        SUBREADBUFFER(dB%theGrid_cb)
!#MPITOOLS_SCRIPT402
    end subroutine
